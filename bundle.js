...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log(_store2.default.getState()); // Run app without UI
	...
	_store2.default.dispatch((0, _todo.addTodo)('My first todo'));
	_store2.default.dispatch((0, _todo.addTodo)('My second todo'));
	
	_store2.default.dispatch((0, _todo.toggleTodo)(0));
	_store2.default.dispatch((0, _todo.toggleTodo)(1));
	
	_store2.default.dispatch((0, _todo.setVisibilityFilter)(_constants.VisibilityFilters.SHOW_COMPLETED));
